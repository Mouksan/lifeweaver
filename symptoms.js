...
export const CYCLE_STATES = {
    heat: {
        ...
        mood: 'на пределе, всё раздражает и всё мало',
        libido: 'всепоглощающее',
        energy: 'лихорадочная, рывками',
        pool: [
            'жар волнами, кожа горит',
            'запах густой, тяжёлый, слышен издалека',
            'внутри тянет и ноет непрерывно',
            'дрожь в руках, трудно устоять',
            'инстинкт искать альфу перебивает разум',
            'прикосновения ощущаются в разы острее',
            'стыд накатывает волнами вперемешку с желанием',
            'сон урывками, тело не даёт отдохнуть',
        ],
    },
    preheat: {
        label: 'Предтечка', tone: 'preheat',
        mood: 'беспокойное, тревожно-приподнятое',
        libido: 'растёт, ещё контролируемо',
        energy: 'нервная, не сидится на месте',
        pool: [
            'тело теплее обычного',
            'запах меняется, становится заметнее',
            'раздражают тесная одежда и чужие прикосновения',
            'тянет обустраивать угол, тащить туда мягкое',
            'сон рваный, просыпается по ночам',
            'чувствительность к запаху альфы обострена',
        ],
    },
    rut: {
        label: 'Гон', tone: 'rut',
        mood: 'взвинченное, собственническое',
        libido: 'неотступное',
        energy: 'избыточная, требует выхода',
        pool: [
            'запах метки на своей паре — единственное, что успокаивает',
            'territorial: чужие рядом вызывают глухое раздражение',
            'мышцы будто под током, тянет двигаться',
            'сон короткий и чуткий',
            'потребность метить и удерживать рядом',
            'терпение на нуле, срывается с полуслова',
    ...
    normal: {
        ...
        energy: 'обычная',
        pool: [
            'тело в покое, ничего не беспокоит',
            'запах ровный, фоновый',
            'сон нормальный',
            'самоконтроль на месте',
        ],
    },
    beta: {
        ...
        libido: 'обычное',
        energy: 'обычная',
        pool: ['цикла нет, состояние стабильное', 'чужие течки и гоны почти не задевают'],
    },
};
...
export function getCycleState(phaseKey, dayInPhase = 1, seed = 0) {
    ...
    return {
        ...
        libido: st.libido,
        energy: st.energy,
        body: seededPick(st.pool, count, seed),
    };
}
